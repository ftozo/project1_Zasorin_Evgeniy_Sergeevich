...
ROOMS = {
    ...
    'secret_room': {
        'description': 'Большая секретная комната. Посередине лежит старая ветхая карта, на которой указан путь к сокровищам. Но для того, чтобы ее получить необходимо решить загадку.',
